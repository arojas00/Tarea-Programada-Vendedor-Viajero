...
public:
    ...
    //Devuelve elemento de una lista
    float*** get(int index){
    ...
    //Devuelve la prioridad de una lista
...
//            }
    ...
    //Dibuja el recorrido del mejor individuo en un plano
    ...
    //Se evalua la calidad del indiviudo y se agrega de manera ordenada en la lista
    ...
    //Selecciona los mejores individuos de la lista
        void elitism(){
            float*** temp;
    ...
    //Selecciona un padre y una madre
        float*** selection(){
    ...
    //Decide si un individuo debe mutar o no, y muta de cualquiera de las tres formas
